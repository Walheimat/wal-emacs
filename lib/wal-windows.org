...
#+begin_src emacs-lisp
(defun wal-in-case-of-single-window-switch-to-other-buffer (&rest _args)
  "Switch to buffer or other window."
  (unless (> (length (wal-interesting-windows)) 1)
    (wal-switch-to-other-buffer)))

(use-package ace-window
  :config
  (advice-add
   'ace-window :before-until
  ...
  :wal-bind
  (("o" . ace-window)
   ("C-M-o" . wal-switch-to-other-buffer)))
#+end_src
