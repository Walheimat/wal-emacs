...
(defun wal-tab-bar-rename-from-project ()
  "Rename the current tab from the current project."
  (interactive)
...
(use-package tab-bar
  ...
  (:map wal-triple-minus-map
   ("t" . wal-tab-bar-rename-from-project)
   :map wal-zero-in-map
   ("t" . wal-tab-bar-switch-to-buffer-tab))
