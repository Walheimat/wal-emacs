...
(use-package cape
  :hook
  (((prog-mode harpoon-prog-like text-mode) . wal-cape-setup)
   (eshell-mode . wal-cape-eshell-setup))

  :functions (cape-file cape-history cape-wrap-super))
#+end_src
...
(defun wal-consult-org-agenda-buffer ()
  "Complete an `org-agenda' buffer."
  (interactive)
