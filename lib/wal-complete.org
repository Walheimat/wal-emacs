...
Beautiful completion and narrowing within completion. This sets up
pre-narrowing, mainly for [[file:wal-bridge.org::*partial-recall][partial-recall]]. It also adds a new source
for projects while switching to differentiate open and closed
