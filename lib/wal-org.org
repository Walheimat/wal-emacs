...
(declare-function org-roam-node-visit "ext:org-roam.el")
(declare-function org-roam-node-read "ext:org-roam.el")
    ...
    (wal-transient-define-major org-mode ()
      ...
      [["Edit"
        ...
        ("." "toggle timestamp" org-toggle-timestamp-type
         :inapt-if-not (lambda () (org-at-timestamp-p 'lax)))
        ("s" "sort" org-sort
...
(defun wal-org-roam-node-find-other-window ()
  "Find an `org-roam' node in another window."
  (interactive)
...
(use-package org-roam
  ...
  (transient-define-prefix wal-org-roam ()
    ...
    [["Capture"
     ...
     ["Find"
      ...
      ("F" "note (other window)" wal-org-roam-node-find-other-window)
  ...
  :bind
  (:map wal-alternate-map ("p" . org-roam-dailies-capture-today)
   :map wal-command-map ("p" . wal-org-roam))

  :wal-bind
  (("p" . org-roam-capture))

  :functions
  (org-roam-db-autosync-enable org-roam-node-visit org-roam-node-read)
