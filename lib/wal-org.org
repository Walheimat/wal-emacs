...
(use-package org-super-agenda
  ...
  (org-super-agenda-groups
   '(;; Scheduled items.
     ...
     (:name "Prepare" :and (:scheduled nil :deadline future) :order 4)
     (:name "Catch up" :deadline past :order 6)
     (:name "Don't forget" :and (:scheduled nil :deadline t) :order 0)

     ;; Habits.
     (:order-multi (5 (:name "Education" :and (:habit t :tag "@education"))
                      (:name "Contribution"
                             :and (:habit t :tag "@contribution"))
