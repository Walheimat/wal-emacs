...
(use-package org-clock
  ...
  ;; Switch state on clock in conditionally.
  (org-clock-in-switch-to-state 'wal-org-clock-in-switch-to-state)
  (org-clock-in-resume t)

  ;; Always switch to waiting, don't leave zero clocks.
  (org-clock-out-switch-to-state "WAITING")
  (org-clock-out-remove-zero-time-clocks t)

  (org-clock-report-include-clocking-task t)

  ;; Clock out automatically and always resolve clocks.
  (org-clock-auto-clockout-timer 60)
  ...
  :functions (org-clock-auto-clockout-insinuate))
#+END_SRC
