...
(use-package lsp-mode
  ...
  (define-key wal-command-map "[" lsp-command-map)
  (that-key-in-map "lsp" :key "[")
...
(use-package dap-mode
  ...
  (define-key wal-command-map "]" wal-dap-command-map)
  (that-key-in-map "dap" :key "]")
