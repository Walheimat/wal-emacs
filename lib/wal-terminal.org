...
#+BEGIN_SRC emacs-lisp
(defun wal-project-vterm (&optional arg)
  "Get a `vterm' buffer for the current project.

If ARG is non-nil, get or create a numbered buffer."
  (interactive "P")
...
(use-package vterm
  ...
  ;; Toggle line numbers while in copy mode.
  (advice-add
   'vterm--enter-copy-mode :after
   #'display-line-numbers-mode)

  (advice-add
   'vterm--exit-copy-mode  :after
  ...
  :general
  (ambassador "t" 'vterm)
  (ambassador "M-t" 'wal-project-vterm)
