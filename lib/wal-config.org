...
(defcustom wal-config-animation-speed 1.0
  "The speed of the whale animation.

This is the time in seconds a single frame will be displayed."
  :type 'float
  :group 'wal-config)
#+END_SRC
...
(defvar wal-config-animation-key-frames
