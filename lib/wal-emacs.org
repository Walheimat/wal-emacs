...
(use-package register
  ...
  :wal-bind
  (("i" . jump-to-register)
   ("M-i" . point-to-register)
   ("C-M-i" . window-configuration-to-register)

   ;; Quick registers.
   ("M-7" . (lambda (&optional arg) (interactive "P") (point-to-register ?7 arg)))
   ("M-8" . (lambda (&optional arg) (interactive "P") (point-to-register ?8 arg)))
   ("M-9" . (lambda (&optional arg) (interactive "P") (point-to-register ?9 arg)))

   ("7" . (lambda (&optional arg) (interactive "P") (jump-to-register ?7 arg)))
   ("8" . (lambda (&optional arg) (interactive "P") (jump-to-register ?8 arg)))
   ("9" . (lambda (&optional arg) (interactive "P") (jump-to-register ?9 arg)))))
#+END_SRC
