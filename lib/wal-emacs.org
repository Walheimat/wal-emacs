...
(use-package register
  ...
  (("p" . point-to-register)
   ...
   ;; Quick registers.
   ("7" . (lambda (&optional arg) (interactive "P") (point-to-register ?7 arg)))
   ("8" . (lambda (&optional arg) (interactive "P") (point-to-register ?8 arg)))
   ("9" . (lambda (&optional arg) (interactive "P") (point-to-register ?9 arg)))

   ("M-7" . (lambda (&optional arg) (interactive "P") (jump-to-register ?7 arg)))
   ("M-8" . (lambda (&optional arg) (interactive "P") (jump-to-register ?8 arg)))
   ("M-9" . (lambda (&optional arg) (interactive "P") (jump-to-register ?9 arg)))))
#+END_SRC
