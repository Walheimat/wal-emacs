...
** hideshow                                              :builtin:negligible:

Hide (and show) blocks.

#+begin_src emacs-lisp
;; From: https://karthinks.com/software/simple-folding-with-hideshow/
(defun wal-hs-cycle (&optional level)
  "Cycle `hideshow', optionally hide up to LEVEL."
  (interactive "p")
...
(use-package hideshow
  ...
  :config
  (defvar-keymap wal-hs-repeat-map
    :doc "Repeat map for `hideshow'."
    :repeat t
    "h" 'wal-hs-cycle)
  ...
  :functions
  (hs-already-hidden-p hs-show-block hs-hide-block hs-hide-level))
#+end_src
...
(use-package hungry-delete
  :hook ((prog-mode harpoon-prog-like) . hungry-delete-mode))
#+end_src
