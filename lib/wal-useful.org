...
(defun wal-switch-to-buffer-obeying-display-actions (buffer-or-name &optional no-record)
  "Switch to BUFFER-OR-NAMe obeying display actions."
  (let ((switch-to-buffer-obey-display-actions t))

    (switch-to-buffer buffer-or-name no-record)))
#+END_SRC
...
(defun wal-insert-after (target preceding item &optional allow-duplicates quiet)
