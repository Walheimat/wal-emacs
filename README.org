...
(use-package mwim
  :config
  (setq wal/fly/docstring (concat wal/fly/docstring ", ⇄ _h_ _;_"))
  (setq wal/fly/heads (append wal/fly/heads '(("h" mwim-beginning nil :exit nil) (";" mwim-end nil :exit nil))))
  :bind
  (("C-a" . mwim-beginning)
   ("C-e" . mwim-end)))
#+END_SRC
...
#+begin_src emacs-lisp
(defun wal/with-bash-shell (fun &rest _args)
  "Run FUN in bash shell."
...
(use-package lsp-java
  ...
  (advice-add
   'dap-java-run-test-class :around
   #'wal/with-bash-shell)

  (advice-add
   'dap-java-run-test-method :around
   #'wal/with-bash-shell)
