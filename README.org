...
(use-package dap-mode
  ...
  (require 'dap-python)
  :general
  (wal/colonel "D" '(dap-mode :wk "dap mode"))
...
(use-package flycheck
  ...
  :general
  (wal/colonel "Q" '(flycheck-mode :wk "toggle flycheck"))
...
(use-package flyspell
  ...
  (wal/colonel prog-mode-map "S" '(flyspell-prog-mode :wk "toggle spell-check (prog)"))
  (wal/colonel "s" '(flyspell-buffer :wk "check spelling"))
  :custom
...
(use-package git-timemachine
  ...
  :general
  (wal/colonel "G" '(git-timemachine-toggle :wk "toggle timemachine")))
#+END_SRC
...
(use-package highlight-indent-guides
  ...
  :general
  (wal/colonel "I" '(highlight-indent-guides-mode :wk "toggle indent highlighting")))
#+END_SRC
...
(use-package lsp-mode
  :general
  (wal/colonel "L" '(lsp-mode :wk "toggle LSP"))
