...
#+BEGIN_SRC emacs-lisp
(defvar wal/smooth-scroll-commands
  '(scroll-up-command
    scroll-down-command
    recenter-top-bottom)
  "Commands that should use smooth scrolling.")

(defun wal/advise-scroll-on-jump ()
  "Advise functions to scroll on jump."
  (mapc (lambda (it)
          (eval `(scroll-on-jump-with-scroll-advice-add ,it)))
        wal/smooth-scroll-commands))

(defun wal/unadvise-scroll-on-jump ()
  "Remove advice from functions to scroll on jump."
  (mapc (lambda (it)
