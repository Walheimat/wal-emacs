...
I've tried to keep custom functions and variables in a scope called
=wal= to avoid potential interference.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-settings.el
;;; wal-settings.el --- Settings. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; The global settings. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-key-bindings.el
;;; wal-key-bindings.el --- Key bindings. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Key bindings package. This file is an export of `README.org'.

;;; Code:

;; FIXME: This variable needs to be set in the init file before the
;;        config is loaded because `general' needs to be demanded.
(defvar wal/use-hyper-prefix t
  "Whether the hyper modifier should be used to prefix leader keys.")

(defun wal/prefix-user-key (user-key)
  "Prefix USER-KEY.
The default prefix is the hyper key unless Emacs is not
running in GUI mode or `wal/use-hyper-prefix' is nil."
  (let ((prefix (if (and wal/use-hyper-prefix (display-graphic-p))
                    "H-"
                  "C-c w ")))
    (concat prefix user-key)))

;; American ranks.
(defconst wal/general-key ";"
  "The primary (or general) leader key.")

(defconst wal/colonel-key "'"
  "The secondary (or colonel) leader key.")

(defconst wal/major-key ","
  "The tertiary (or major) leader key.")

(defconst wal/captain-key "."
  "The quaternary (or captain) leader key.")

(defconst wal/lieutenant-key "/"
...
Saving the config after finding it with this function
...
(defun use-package-handler/:wal-bind (name _keyword args rest state &optional bind-macro)
  (use-package-concat
...
(wal/insert-use-package-keyword :wal-bind :bind)
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-func.el
;;; wal-func.el --- Additional functions. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Additional functions package. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-func.el
(defcustom wal/gc-cons-threshold-in-mb 10
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-look.el
;;; wal-look.el --- Look. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide packages for the look of the config. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-fonts.el
;;; wal-fonts.el --- Fonts. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide font setup and configuration. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-emacs.el
;;; wal-emacs.el --- Emacs. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide Emacs settings/configurations. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-edit.el
;;; wal-edit.el --- Editing. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide editing packages. This file is an export of `README.org'.
...
Makes sure that indentation variables don't produce
unexpected results."
  (interactive)
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-visuals.el
;;; wal-visuals.el --- Visuals. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide visual packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-windows.el
;;; wal-windows.el --- Windows. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide window packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-movement.el
;;; wal-movement.el --- Movement. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide movement packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-find.el
;;; wal-find.el --- Finding things. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide packages to find things. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-complete.el
;;; wal-complete.el --- Completion. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide Emacs completion packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-workspace.el
;;; wal-workspace.el --- Workspace. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide workspace packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-org.el
;;; wal-org.el --- Org. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide org packages/configurations. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-dired.el
;;; wal-dired.el --- Dired. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide dired packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-terminal.el
;;; wal-terminal.el --- Terminal. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide terminal packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-vc.el
;;; wal-vc.el --- Version control. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide version control packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-lang.el
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-fix.el
;;; wal-fix.el --- Fixing things. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide fixing packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-lsp.el
;;; wal-lsp.el --- LSP. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide LSP packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-lsp.el
(defcustom wal/lsp-file-watch-ignored
  '("[/\\\\]_build$"
    "[/\\\\]deps$")
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-devops.el
;;; wal-devops.el --- DevOps. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide DevOps packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-web.el
;;; wal-web.el --- The Internet. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide web packages. This file is an export of `README.org'.
...
#+BEGIN_SRC emacs-lisp :tangle ./wal/wal-writing.el
;;; wal-writing.el --- Writing. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Provide writing packages. This file is an export of `README.org'.
...
The root package of the configuration.

#+BEGIN_SRC emacs-lisp :tangle ./wal/wal.el
;;; wal.el --- Walheimat's literate Emacs configuration. -*- lexical-binding: t; -*-

;;; Commentary:
;;
;; Require all sub-packages. This file is an export of `README.org'.
...
(require 'wal-settings)
(require 'wal-key-bindings)
(require 'wal-func)
(require 'wal-look)
(require 'wal-fonts)
(require 'wal-emacs)
...
(require 'wal-visuals)
(require 'wal-windows)
(require 'wal-movement)
(require 'wal-find)
(require 'wal-complete)
(require 'wal-workspace)
(require 'wal-org)
(require 'wal-dired)
(require 'wal-terminal)
(require 'wal-vc)
(require 'wal-lang)
(require 'wal-fix)
(require 'wal-lsp)
...
[fn:6] Not including where =:tangle no= was set, 157 code blocks on my
last count.
