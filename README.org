...
(use-package helpful
  ...
  :general
  (wal/major :keymaps '(emacs-lisp-mode-map org-mode-map) :major-modes t
...
(use-package smooth-scroll-mode
  ...
  :general
  (wal/colonel "," '(smooth-scroll-mode :wk "smooth-scroll")))
#+END_SRC
...
(use-package tree-sitter
  :delight " trs"
  :general
  (wal/captain :keymaps wal/tree-sitter-mode-maps
