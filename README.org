...
(defun wal/merge-ligatures (mode-ligatures)
  "Merge common ligatures with MODE-LIGATURES."
  (append mode-ligatures wal/common-ligatures))

(use-package ligature
  :hook (prog-mode . ligature-mode)
  :load-path "site-lisp"
  :config
  (ligature-set-ligatures 'lisp-data-mode (wal/merge-ligatures '(";;")))
  (ligature-set-ligatures 'c++-mode (wal/merge-ligatures
                                     '("::" "->" ">>" "<<"
                                       "++" "!=" "|=" "<<="
                                       ">>=" "==")))
  (ligature-set-ligatures 'python-mode (wal/merge-ligatures
                                        '("->" "!=" "==")))
  (ligature-set-ligatures 'js2-mode (wal/merge-ligatures
                                     '("=>" "!==" "===" "!!"
                                       "&&")))
  (ligature-set-ligatures 'elixir-mode (wal/merge-ligatures
                                        '("|>" "#{" "\\\\")))
  (ligature-set-ligatures 'prolog-mode (wal/merge-ligatures '(":-")))
  (ligature-set-ligatures 'html-mode (wal/merge-ligatures '("<!--" "-->"))))
#+END_SRC
...
[fn:6] Not including where =:tangle no= was set, 157 code blocks on my last count.
