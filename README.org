...
(use-package helpful
  ...
  :general
  (wal/colonel "h" '(helpful-at-point          :wk "helpful at point"))
  (wal/major   "h" '(counsel-describe-variable :wk "describe variable"))
  (wal/captain "h" '(counsel-describe-function :wk "describe function"))
  :bind
