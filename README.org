...
#+BEGIN_SRC emacs-lisp
(defun wal/ryo-reset-cursor-color ()
  "Reset cursor color after theme change."
  (setq ryo-modal-default-cursor-color (face-attribute 'cursor :background)
        ryo-modal-cursor-color (face-attribute 'highlight :background)))
...
(use-package ryo-modal
  ...
  :hook (wal/theme . wal/ryo-reset-cursor-color)
