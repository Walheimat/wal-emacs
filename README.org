...
respective section's package. Each package has a *Header* and a *Footer*
that contains declarations for the package.
...
Most bindings are declared in the [[*Package Configurations][packages]] section.
...
Cousnel me this, Counselor: =ivy= is not enough!
...
Run =dired= [fn:15]with =C-x d=. You don't need no treeviews.
...
(use-package dap-mode
  ...
  :general
  (wal/colonel :keymaps 'lsp-mode-map
    "d" '(dap-mode :wk "dap"))
