...
(defun use-package-handler/:wal-bind (name _keyword args rest state &optional bind-macro)
  "Handler for keyword `:wal-bind'.

It's a copy of the handler for `:bind'."
  (use-package-concat
...
(load "wal-settings" t t)
(load "wal-key-bindings" t t)
(load "wal-func" t t)
(load "wal-look" t t)
(load "wal-fonts" t t)
(load "wal-emacs" t t)
(load "wal-edit" t t)
(load "wal-visuals" t t)
(load "wal-windows" t t)
(load "wal-movement" t t)
(load "wal-find" t t)
(load "wal-complete" t t)
(load "wal-workspace" t t)
(load "wal-org" t t)
(load "wal-dired" t t)
(load "wal-terminal" t t)
(load "wal-vc" t t)
(load "wal-lang" t t)
(load "wal-fix" t t)
(load "wal-lsp" t t)
