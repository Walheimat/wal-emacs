...
Toggle indentation, allow for automatic acivation from local
variables.
...
(ert-deftest test-wal/apply-padding-to-string ()
  (let ((test-string "hello"))
    (should (equal " hello" (wal/apply-padding-to-string test-string)))))
#+END_SRC
