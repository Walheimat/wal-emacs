...
Leader key =conolel= should only prefix actions that make sense within
...
(use-package dap-mode
  ...
  (wal/colonel "h"  '(dap-hydra :wk "debug hydra") :keymaps 'dap-mode-map ))
#+END_SRC
...
(use-package flycheck
  ...
  (wal/colonel   "n" '(flycheck-next-error :wk "next error") :keymaps 'flycheck-mode-map)
...
(use-package helpful
  ...
  :general
  (wal/major      "h" '(helpful-at-point          :wk "helpful at point")  :keymaps 'emacs-lisp-mode-map)
  (wal/captain    "h" '(counsel-describe-variable :wk "describe variable") :keymaps 'emacs-lisp-mode-map)
  (wal/lieutenant "h" '(counsel-describe-function :wk "describe function") :keymaps 'emacs-lisp-mode-map)
  :bind
...
(use-package ivy
  ...
  (ivy-wrap                t)
  :general
  (wal/colonel "b" '(ivy-resume :wk "resume ivy"))
