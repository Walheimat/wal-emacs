...
I [[file:docs/hyper.org][re-bound]] my =<CAPS>= (caps-lock) key to =Hyper_L= to use the hyper
...
[fn:15] Binding reference [[http://oremacs.com/lispy/][here]].
