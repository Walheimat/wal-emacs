...
(use-package consult
  ...
  :commands (wal/univ-consult-buffer)
  :demand
  :after vertico)
#+END_SRC
...
(wal/define-expansion-pack eshell
  :packages (esh-autosuggest eshell-prompt-extras eshell-syntax-highlighting))
#+END_SRC
...
(use-package magit
  ...
  :commands (wal/univ-magit-status-quick))
#+END_SRC
...
(use-package dap-mode
  ...
  (wal/lieutenant :keymaps 'lsp-mode-map
    "d" '(wal/dap-hydra/body :wk "debug (minimal)"))
  :after lsp-mode
  :delight " dap")
#+END_SRC
