...
The =general= mappings perform useful but not
foundational actions (say instead of switching
projects we can =ag-project=).

#+BEGIN_SRC emacs-lisp
;; if already bound, just pick another that suits you
(defconst wal/leader-key "C-."
  "Wal's leader key.")

(use-package general
  :config
  (general-create-definer wal/leader
    :prefix wal/leader-key))
#+END_SRC
...
(set-face-attribute 'variable-pitch nil
  :font "Roboto" ;; you might want to change this one
...
(use-package counsel
  :general
  (wal/leader "t" '(counsel-load-theme :which-key "load theme"))
...
(use-package flycheck
  ...
  :general
  (wal/leader "q" '(flycheck-mode :which-key "toggle fylcheck"))
...
(use-package git-timemachine
  :general
  (wal/leader "m" '(git-timemachine-toggle :which-key "toggle git timemachine")))
#+END_SRC
...
(use-package google-this
  :diminish
  :general
  (wal/leader "g" '(google-this-region :which-key "google selected region"))
...
(use-package lsp-mode
  :general
  (wal/leader "l" '(lsp-mode :which-key "toggle LSP"))
  :custom
...
(use-package perspective
  ...
  :general
  (wal/leader "i" '(persp-kill :which-key "kill perspective"))
...
(use-package projectile
  :diminish " pjt"
  :general
  (wal/leader "f" '(projectile-find-file :which-key "find file in project")) 
...
(use-package writeroom-mode
  ...
  :general
  (wal/leader "w" '(writeroom-mode :which-key "toggle writeroom"))
...
(use-package org-super-agenda
  ...
  :general
  (wal/leader "a" '(org-agenda :which-key "open agenda"))
