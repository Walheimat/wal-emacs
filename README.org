...
(with-no-warnings
  (transient-define-prefix wal-config-captain ()
...
(defun harpoon-treesit--ts-name (name)
...
(cl-defmacro harpoon-treesit (name)
  ...
  (when-let* ((ready (harpoon-treesit--ready-p name))
              (mode-name name)
              (ts-mode-name (harpoon-treesit--ts-name name)))
...
CAPTAIN is either t or nil. If it is t, a suffixed function will
be mapped to the captain key.
...
(use-package org
  ...
  (with-no-warnings
    (wal/transient-define-prefix-once org-mode-captain ()
...
(use-package org-roam
  ...
  (wal/transient-define-prefix-once org-roam-captain ()
...
(use-package dired
  ...
  (wal/transient-define-prefix-once dired-mode-captain ()
...
(use-package magit
  ...
  :config
  (wal/transient-define-prefix-once magit-captain ()
...
(use-package cc-mode
  ...
  (wal/transient-define-prefix-once c++-mode-captain ()
...
(use-package rust-mode
  ...
  :config
  (wal/transient-define-prefix-once rust-mode-captain ()
...
(use-package python
  ...
  (wal/transient-define-prefix-once python-mode-captain ()
...
(use-package lsp-pyright
  ...
  :config
  ;; TEMP: Allow `python-ts-mode'.
  (when (harpoon-treesit--ready-p 'python-mode)
    (defvar lsp-clients)

    (when-let* ((struct (gethash 'pyright lsp-clients)))
...
(use-package elisp-mode
  ...
  :config
  (wal/transient-define-prefix-once emacs-lisp-mode-captain ()
...
(use-package lisp-mode
  ...
  (with-eval-after-load 'slime
    (wal/transient-define-prefix-once common-lisp-mode-captain ()
...
(use-package clojure-mode
  ...
  (with-eval-after-load 'cider
    (wal/transient-define-prefix-once clojure-mode-captain ()
...
(use-package js
  ...
  (wal/transient-define-prefix-once js-mode-captain ()
    "Access JS commands."
    [["Actions"
...
(use-package markdown-mode
  ...
  :config
  (wal/transient-define-prefix-once markdown-mode-captain ()
...
(use-package lsp-dart
  ...
  (wal/transient-define-prefix-once dart-mode-captain ()
...
(use-package lsp-java
  ...
  (wal/transient-define-prefix-once java-mode-captain ()
...
(use-package lsp-mode
  ...
  (wal/transient-define-prefix-once lsp-captain ()
  ...
  :general
  (wal/major :keymaps 'lsp-mode-map "l" '(lsp-captain :wk "lsp"))
...
(use-package dap-mode
  ...
  (with-eval-after-load 'lsp-mode
    (transient-append-suffix 'lsp-captain '(0 -1)
      ["Debug"
       ("b" "start" dap-debug)]))
...
(use-package verb
  ...
  :config
  (wal/transient-define-prefix-once verb-captain ()
