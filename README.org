...
Both functions will be called interactively. The
`current-prefix-arg' is consumed by setting it to nil."
...
This adds additional ignored directories."
  ...
  (transient-define-prefix wal/lsp-dispatch ()
    ...
    [["Format"
     ...
     ["Actions"
      ("x" "execute" lsp-execute-code-action)
