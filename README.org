    ...
    (wal/transient-define-major org-mode ()
      ...
      [["Subtree"
       ...
       ["Footnotes"
        ...
        ("F" "normalize footnotes" org-footnote-normalize)]
      ...
      [["Levels"
        ("l" "up to level" wal/org-content)
        ("L" "show all" org-show-all)]
       ["Other"
...
(use-package org-src
  ...
  (transient-append-suffix 'org-mode-major '(0 3 -1)
...
(use-package lsp-mode
  ...
  ;; Command map.
  (setq lsp-keymap-prefix (wal/key-combo-for-leader 'wal/ambassador :key "l"))
  (lsp-enable-which-key-integration t)
  (wal/ambassador :keymaps 'lsp-mode-map "l" '(:keymap lsp-command-map :wk "LSP"))
