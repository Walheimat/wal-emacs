...
(with-no-warnings
  ...
  (defvar-keymap wal/other-window-repeat-map
    :doc "Keymap to repeat `wal/other-window'."
    :repeat t
    "o" 'wal/other-window)
...
#+BEGIN_SRC emacs-lisp
(defvar wal/general-leaders '(wal/editor wal/ambassador wal/general)
...
(cl-defmacro wal/editor! (key fun mfun &rest args)
...
(use-package multiple-cursors
  ...
  :general
  (wal/editor! "." 'mc/mark-all-like-this  'mc/edit-ends-of-lines))
#+END_SRC
...
(defun wal/first-undo-treemacs-meddling (&rest _args)
  "Make sure `treemacs-mode' windows may be targets."
    ;; Undo action by `treemacs' that forces its buffers to be ignored.
  (when (and (boundp 'aw-ignored-buffers)
             (memq 'treemacs-mode aw-ignored-buffers))
...
(use-package ace-window
  ...
  ;; Undo what `treemacs-compatibility' does.
  (advice-add
   'ace-window :before
...
(use-package avy
  ...
  :general
  ;; Lines.
  (wal/editor! "c" 'avy-copy-line 'avy-copy-region)
  (wal/editor! "x" 'avy-kill-whole-line 'avy-kill-region)
  (wal/editor! "m" 'avy-move-line 'avy-move-region)
  (wal/editor! "w"
