...
(defun junk-package-vc-install (recipe)
  ...
  (if (fboundp 'package-vc-install)
      (package-vc-install (cadr recipe))
...
#+BEGIN_SRC emacs-lisp
(defvar wal/sidecar-packages nil
  "Packages that are part of external packages but not explicitly installed.")

(defun wal/sidecar-package-p (package)
  "Check if PACKAGE is a sidecar package."
  (memq package wal/sidecar-packages))

(defun wal/ignore-if-not-installed (package &rest _r)
  "Don't handle hooks if PACKAGE isn't installed."
  (or (package-installed-p package)
      (package-built-in-p package)
      (wal/sidecar-package-p package)))
...
(use-package vertico
  ...
  :init
  (add-to-list 'wal/sidecar-packages 'vertico-directory)
...
#+BEGIN_SRC emacs-lisp
(defvar wal/org-agenda-file ".agenda")
...
(defun wal/org-capture-find-project-task-location ()
  "Find the location of tasks in the file."
  ...
  (org-capture-templates
   `(("c" "current task" plain
     ...
     ("p" "project task" entry
      (function wal/org-capture-find-project-task-location)
      "* TODO %?\n\n%F\n\n%i"
      :empty-lines-before 1)))
