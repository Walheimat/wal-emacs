...
(use-package whitespace-mode
  :ensure nil
  :hook
  (whitespace-mode . (lambda nil (highlight-indent-guides-mode -1)))
  :general
...
(defvar wal/tree-slide-visual-fill-column-width 160
  "The `visual-fill-column-width' for `org-tree-slide' presentations.")

(defun wal/tree-slide-calculate-relative-visual-fill-column-width ()
  "Calculate a `visual-fill-column-width' relative to text scaling."
  (/ wal/tree-slide-visual-fill-column-width
...
(defun wal/tree-slide-play ()
  "Make presentable."
  (setq visual-fill-column-width (wal/tree-slide-calculate-relative-visual-fill-column-width)
