...
(defun wal/configure-popper ()
  ...
  (defhydra wal/popper (:hint nil)
    "
%s`wal/ascii-whale Pop-ups: _t_oggle or _c_ycle.
"
    ("t" popper-toggle-latest :color blue)
    ("c" popper-cycle)
    ("a" wal/popper-open-all "show all")
    ("x" wal/popper-bury-all "bury all")
    ("q" nil "quit")))
