...
(defun wal/popper-dwim ()
  "Figure out what to do with regards to pop-ups.

If the current buffer is a pop-up, call the hydra, otherwise just
toggle the latest pop-up."
  (interactive)
  (if (and (popper-popup-p (current-buffer))
           (fboundp 'wal/popper/body))
      (wal/popper/body)
