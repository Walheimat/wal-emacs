...
Both functions will be called interactively."
  ...
  (let ((a-name (symbol-name a))
    ...
    `(defun ,(intern (concat a-name parallel--separator b-name)) (&optional call-other)
...
(defun junk--install-extras (extras)
  ...
  (let* ((selection (wal/maybe-intern
                     (completing-read
...
#+BEGIN_SRC emacs-lisp
(defun wal/maybe-org-roam-refile (&optional arg)
...
(defun wal/dap-stopped (_session)
  "(Re-)display the transient immediately."
