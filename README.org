...
(wal/define-expansion-pack javascript
  ...
  :packages (js2-mode add-node-modules-path jsonian)
...
(use-package jsonian
  ...
  ;; HACK: Since `json-mode' is a dependency for `docker', we
  ;;       remove it the hard way.
  (with-eval-after-load 'json-mode
    (setq auto-mode-alist (delete json-mode--auto-mode-entry auto-mode-alist)))
  :general
  ...
  (("\\.json\\'" . jsonian-mode)
   ("\\.arb\\'" . jsonian-mode))
  :hook (jsonian-mode . wal/jsonian-mode)
  :after so-long
  :ensure nil)
#+END_SRC
