...
(use-package general
  ...
  (wal/create-leader-sink wal/major-sink :definer wal/major :prefix wal/major-key)
  (wal/create-leader-sink wal/lieutenant-sink :definer wal/lieutenant :prefix wal/lieutenant-key))
#+END_SRC
...
(use-package lsp-mode
  ...
  (lsp-prefer-capf t)
  (lsp-idle-delay 1.5)
  (lsp-enalbe-dap-auto-configure nil)
