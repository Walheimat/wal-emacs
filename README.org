...
(defvar ryo-modal-default-cursor-color)
(defvar ryo-modal-cursor-color)
...
(defun wal/avy-ryo-after ()
  "Make sure `ryo-modal-mode' is carried to other buffers."
  (when-let ((prev wal/avy-ryo-buffer)
             (curr (current-buffer)))
