...
If you use Xorg Display Server, the risky quite[fn:9] way would be to
...
What follows is a list of packages[fn:10] that make Emacs even more
awesome.
...
packages[fn:11] and some external ones.
...
(use-package crux
  ...
  (("M-o" . crux-other-window-or-switch-buffer)
   ...
   ("H-D" . crux-duplicate-and-comment-current-line-or-region)
...
[[https://github.com/ggreer/the_silver_searcher#installation][here]][fn:13].
...
[fn:10] Mostly from MELPA. /Note/ that many packages bind keys. Check
