...
+ =H-\= toggles =vterm=
+ =H-u= toggles latest pop-up using =popper=
...
Leader key =colonel= (=<;>= by default) prefixes editing actions.
...
;; Editing.
(wal/colonel
  "h" '(wal/kill-ring-save-whole-buffer :wk "kill-ring-save buffer"))
...
(wal/general
 "F" '(:ignore t :wk "select font")
 "Ff" '(wal/select-fixed-font :wk "fixed")
 "Fv" '(wal/select-variable-font :wk "variable"))
...
(use-package simple
  ...
  ("C-?" . undo-redo)
  :general
  (wal/general-sink "p" '(list-processes :wk "processes"))
...
(use-package cus-edit
  :general
  (wal/general
    "c" '(:ignore t :wk "customization")
    "cw" '(wal/customize-wal :wk "wal"))
  :ensure nil)
#+END_SRC
...
(use-package crux
  ...
  (wal/colonel
    ...
    "o" '(crux-smart-open-line :wk "open line"))
  (wal/colonel-sink :keymaps 'prog-mode-map
    "d" '(crux-duplicate-and-comment-current-line-or-region :wk "duplicate and comment")
    "o" '(curx-smart-open-line-above :wk "open line above"))
  (wal/lieutenant
    "x" '(:ignore t :wk "crux")
...
"
    ("c" popper-cycle)
    ("o" wal/popper-open-all)
    ("b" wal/popper-bury-all)
    ("q" nil "quit")))
...
(defun wal/configure-consult ()
 ...
 (use-package consult
  ...
  (("j" . consult-buffer))
  :general
  (wal/general "ct" '(consult-theme :wk "consult theme"))
  (wal/major :keymaps 'org-mode-map :major-modes t
    "h" '(consult-org-heading :wk "heading"))
...
(use-package counsel
  ...
  :general
  (wal/general
    "ct" '(counsel-load-theme :wk "counsel theme")
...
Run =dired= [fn:15]with =C-x d=. You don't need no tree views.
...
[fn:15] Did you know you can edit =dired= buffers using =C-x C-q=?
