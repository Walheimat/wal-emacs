...
#+BEGIN_SRC emacs-lisp
(defalias 'use-package-normalize/:wal-ways 'use-package-normalize/:if)
...
(defun use-package-handler/:wal-ways (name _keyword pred rest state)
  ...
  (when (fboundp 'use-package-process-keywords)
    (let ((body (use-package-process-keywords name rest state)))
      `((when (or ,pred (not ,wal/minimal)) ,@body)))))
...
(declare-function wal/ascii-whale-setup "wal.el")
(declare-function wal/ascii-whale-toggle-display "wal.el")
