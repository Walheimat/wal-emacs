...
Better[fn:12] than =vterm= included shells.
...
You'll have to install some language servers yourself[fn:13].
...
[fn:12] If you're on an older distro your =libvterm= package might be too old.
