...
(use-package projectile
  ...
  (transient-define-suffix wal/projectile-maybe-tokei ()
    "Run `tokei' if it is bound."
    :key "?"
    :description "tokei"
    :inapt-if-not (lambda () (fboundp 'tokei))
    (interactive)
    (call-interactively 'tokei))
