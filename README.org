...
;; (wal/leader "4" '(kill-buffer-and-window :which-key "kill buffer and window"))
...
(defconst wal/secondary-emacs-theme 'kaolin-valley-light
...
(use-package ag
  ...
  (ag-ignore-list      '("[/\\\\]\\.git\\'"
		         ...
		         "[/\\\\]deps\\'"))
  :general
  (wal/colonel "f" '(ag-files :which-key "find in files of type"))
  :bind (("C-c f a" . ag)
         ("C-c f p" . ag-project)
         ("H-f"     . ag-project)
...
(use-package avy
  :general
  (wal/general "v" '(avy-goto-whitespace-end :which-key "go to whitespace"))
  (wal/colonel "v" '(avy-kill-whole-line :which-key "kill specific line"))
  (wal/major   "v" '(avy-copy-line :which-key "copy line and paste above"))
...
(use-package counsel
  ...
  (wal/major "#" '(counsel-load-theme :which-key "load theme"))
  (wal/major "$" '(counsel-command-history :which-key "command history"))
  (wal/major "!" '(counsel-set-variable :which-key "set variable"))
...
(use-package docker
  ...
  :general
  (wal/general "k" '(docker-compose-up :which-key "docker-compose up"))
  (wal/colonel "k" '(docker-compose-exec :which-key "docker-compose exec"))
  (wal/major   "k" '(docker-compose-logs :which-key "docker-compose logs"))
  :bind (("C-c k" . docker)
         ("H-k"   . docker)))
#+END_SRC
...
(if (daemonp)
    (add-hook 'server-after-make-frame-hook 'wal/fira-code)
    (wal/fira-code))
#+END_SRC
...
(use-package flycheck
  ...
  :general
  (wal/major "q" '(flycheck-mode :which-key "toggle flycheck"))
...
(use-package git-timemachine
  :general
  (wal/colonel "@" '(git-timemachine-toggle :which-key "toggle git timemachine")))
#+END_SRC
...
(use-package google-this
  :diminish
  :general
  (wal/general "g" '(google-this :which-key "google this"))
  (wal/colonel "g" '(google-this-region :which-key "google selected region"))
  (wal/major   "g" '(counsel-google :which-key "google with counsel"))
...
(use-package helpful
  ...
  :general
  (wal/general "h" '(counsel-describe-variable :which-key "describe variable"))
  (wal/colonel "h" '(counsel-describe-function :which-key "describe function"))
  (wal/major "h" '(helpful-at-point :which-key "helpful at point"))
  :bind
...
(use-package lsp-mode
  :general
  (wal/major "l" '(lsp-mode :which-key "toggle LSP"))
  :custom
...
(use-package perspective
  ...
  :general
  (wal/general "i" '(persp-kill :which-key "set buffer to perspective"))
  (wal/colonel "i" '(persp-add-buffer :which-key "add buffer to perspective"))
  (wal/major "i" '(persp-remove-buffer :which-key "remove buffer from perspective"))
...
(use-package prettier
  :general
  (wal/general js2-mode-map "," '(prettier-prettify :which-key "prettify")))
#+END_SRC
...
(use-package projectile
  :diminish " pjt"
  :general
  (wal/general "p" '(projectile-find-file :which-key "find file in project")) 
  (wal/colonel "p" '(projectile-find-dir :which-key "find dir in project")) 
  (wal/major   "p" '(projectile-kill-buffers :which-key "kill project buffers")) 
...
(use-package swiper
  :after ivy
  :general
  (wal/general "s" '(swiper-all :which-key "search all buffers"))
  (wal/colonel "s" '(swiper-multi :which-key "search multiple buffers"))
  (wal/major   "s" '(swiper-thing-at-point :which-key "search thing at point"))
  :bind (("C-c s" . swiper)
         ("H-s"   . swiper)
         (:map swiper-map
               ("C-c v" . swiper-avy))))
...
(use-package typo
  :diminish " typ"
  :general
  (wal/general text-mode-map "," '(typo-mode :which-key "toggle typo mode")))
#+END_SRC
...
(use-package writeroom-mode
  ...
  :general
  (wal/major "w" '(writeroom-mode :which-key "toggle writeroom"))
...
(use-package yasnippet
  :delight " yas"
  :general
  (wal/general "y" '(yas-visit-snippet-file :which-key "visit snippet file"))
  (wal/colonel "y" '(yas-new-snippet :which-key "create new snippet"))
  (wal/major   "y" '(yas-minor-mode :which-key "toggle yasnippet"))
...
(use-package org-super-agenda
  ...
  :general
  (wal/general org-agenda-keymap "w" '(org-agenda-write :which-key "write agenda"))
...
(use-package org-tree-slide
  ...
  :general
  (wal/general org-mode-map "," '(org-tree-slide-mode :which-key "slideshow"))
