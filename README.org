...
+ =H-h= finds project file using =counsel-projectile=
+ =H-i= switches =perspective=
+ =H-j= switches to buffer using =counsel-projectile=
...
[fn:6] Not including where =:tangle no= was set, 162 (on my last count)
