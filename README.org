...
(defun wal/other-displayed-frame-p (frame)
...
(defun wal/display-buffer-other-frame (buffer)
  "Display BUFFER, preferably in another frame.
...
(defalias 'wdb/other-frame 'wal/display-buffer-other-frame)
#+END_SRC
...
(declare-function wal/univ-p "wal-func.el")
(declare-function wdb/other-frame "wal-func.el")
