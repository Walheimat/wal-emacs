...
(defvar wal/ascii-whale-border-color nil)
...
(defun wal/ascii-whale-setup ()
  ...
  (when (featurep 'posframe)
    ...
    (setq wal/ascii-whale-border-color (face-attribute 'mode-line-highlight :background nil t))
...
(defun wal/ascii-whale-display ()
  ...
  (let ((default-frame-alist nil))
    (posframe-show
     ...
     :border-color wal/ascii-whale-border-color
