...
+ =H-z= opens notes index file.
+ =H-m= to list all bookmarks.
...
(use-package sudo-edit
  ...
  :general
  (wal/sergeant "s" '(sudo-edit-find-file :wk "find file as root")))
#+END_SRC
...
(use-package org-roam
  ...
  :bind ("H-z" . org-roam-jump-to-index)
  :config
...
(use-package consult-flycheck
  ...
  (wal/captain :keymaps 'flycheck-mode-map
    "f" '(consult-flycheck :wk "search error")))
#+END_SRC
...
(use-package eww
  :ensure nil
  :general
  (wal/sergeant "w" '(eww :wk "www the web")))
#+END_SRC
