...
:END:
 ...
 And the =ag= one from [[https://github.com/ggreer/the_silver_searcher#installation][here]][fn:13].
...
Run =dired= [fn:14]with =C-x d=. You don't need no tree views.
...
[fn:14] Did you know you can edit =dired= buffers using =C-x C-q=?
