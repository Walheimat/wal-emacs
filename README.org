...
(defconst my-primary-emacs-theme 'kaolin-aurora
  "The quote-unquote default emacs theme.")

(defconst my-secondary-emacs-theme 'brutalist
...
(defun ivy-switch-ignored-buffers (&rest r)
  "Show only commonly ignored buffers."
  (interactive)
  (let ((ivy-ignore-buffers
	 '((lambda(buffer-or-string)
	     (if (is-commonly-ignored-buffer buffer-or-string)
		 nil
	       t)))))
    (my-switch-buffer r)))
#+END_SRC
...
(use-package ivy
  ...
  :bind (("C-x b" . my-switch-buffer)
         ...
         ("H-B" . ivy-switch-ignored-buffers)
         ("<f9>"  . ivy-resume))
  :config
  (ivy-mode 1))
#+END_SRC
