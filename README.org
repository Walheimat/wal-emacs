...
Leader key =colonel= deals with the global context.
...
Leader key =major= deals with the (buffer-)local context.
...
(defvar wal/general-leaders '(wal/lieutenant nil wal/major wal/colonel wal/general))
...
"
  ...
  (defhydra wal/fly (:hint nil :foreign-keys warn)
    "
%s`w/hew Fly: ✜ _i_ _j_ _k_ _l_ %s`w/hs ⇆ _u_ _o_ %s`w/hs ⇄ _h_ _;_ %s`w/hs ↷ _a_ _s_ _d_ _f_ _g_ %s`w/hs ⇅ _,_ _._
"
    ("u" backward-word)
    ("i" previous-line)
    ("o" forward-word)
...
(use-package dictionary
  ...
  :general
  (wal/major "D" '(dictionary-lookup-definition :wk "dict")))
#+END_SRC
