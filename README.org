...
Leader key =general= should only prefix actions that should be possible
no matter the major mode.

Leader key =colonel= should only prefix actions that make sense within
...
(use-package evil-nerd-commenter
  :bind (("H-c"   . evilnc-comment-or-uncomment-lines)
...
(use-package flycheck
  ...
  (wal/colonel flycheck-mode-map "n" '(flycheck-next-error :wk "next error"))
...
(use-package ivy
  ...
  (ivy-wrap                t)
  :general
  (wal/colonel "i" '(ivy-resume :wk "resume ivy"))
...
(use-package writeroom-mode
  ...
  :general
  (wal/global "r" '(writeroom-mode :wk "toggle writeroom")))
#+END_SRC
