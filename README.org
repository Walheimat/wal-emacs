...
(defvar wal/hook--function-keywords '(:corfu
                                      :captain
                                      :functions
                                      :lsp
                                      :messages
...
(defun wal/hook--get-function-values (args)
  "Collect function keywords from ARGS."
  (cl-loop for kw in wal/hook--function-keywords
           collect (plist-get args kw)))

(defun wal/hook--get-function-name (name suffix &optional prefix)
  "Get function name for NAME."
...
(defmacro wal/hook--function (name docs args)
  "Create hook function NAME from ARGS with DOCS."
  (declare (indent defun))

  (cl-destructuring-bind
      (corfu captain functions lsp messages prog-like shallow tabs)
      (wal/hook--get-function-values args)
...
The rest of the BODY will be spliced into the lambda."
  ...
  (let* ((ts (wal/hook--treesit treesit name)))
    ...
    `(progn
       (wal/hook--function ,name ,docs ,body)
