...
Fittingly, all =major mode= toggle actions are invoked
...
(defun wal/fira-code()
  (use-package fira-code-mode
    ...
    :custom
    (fira-code-mode-disabled-ligatures '("[]" "x"))  ; ligatures you don't want
    :hook prog-mode))
...
(use-package flycheck
  ...
  :general
  (wal/major "q" '(flycheck-mode :which-key "toggle fylcheck"))
