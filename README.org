...
Leader key =lieutenant= (='= by default) is unused.
...
(use-package consult
  ...
  (with-eval-after-load 'flycheck
    (transient-append-suffix 'wal/flycheck '(0 0 1)
...
(use-package org-tree-slide
  ...
  (transient-append-suffix 'wal/org '(0 2)
    ["Presentation"
...
(use-package org-src
  ...
  (transient-append-suffix 'wal/org '(0 0 1)
...
(use-package org-transclusion
  ...
  (transient-append-suffix 'wal/org '(0 0 2)
...
(use-package python-isort
  ...
  :config
  (transient-append-suffix 'wal/python '(0 1 -1)
...
(use-package prettier
  ...
  :config
  (transient-append-suffix 'wal/js '(0 0 0)
...
(use-package flycheck
  ...
  :config
  (transient-define-prefix wal/flycheck ()
...
(use-package lsp-mode
  ...
  (with-eval-after-load 'js2-mode
    (transient-append-suffix 'wal/js '(0 0 -1)
