...
(use-package consult-flycheck
  ...
  (wal/captain :keymaps 'flycheck-mode-map
               "e" '(consult-flycheck :wk "find error")))
#+END_SRC
...
(use-package flyspell-correct
  ...
  :general
  (wal/captain :keymaps 'flyspell-mode-map
               "c" '(flyspell-correct-wrapper :wk "flyspell correct")))
...
(unless (version< emacs-version "27.0")
  (use-package vterm
    ...
    (wal/major :keymaps 'vterm-mode-map
               "w" '(vterm-copy-mode :wk "enter copy mode"))
    (wal/major :keymaps 'vterm-copy-mode-map
               "w" '(vterm-copy-mode :wk "exit copy mode"))
    :config
...
(use-package org-roam
  ...
  (wal/major :keymaps 'org-mode-map
             "r" '(org-roam-find-file        :wk "find file (roam)"))
