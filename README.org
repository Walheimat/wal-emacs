...
+ =C-c r= to dispatch =consult-register-*= commands
+ =C-c s= to do =consult-line=
+ =C-c t= for =vterm=
...
(use-package consult
  ...
  (transient-define-prefix wal/consult-dispatch ()
    ...
    [["Find"
     ...
     ["Do"
      ("r" "register" wal/register-dispatch)
     ...
     ["Narrow"
      ...
      ("n" "line" consult-line)]])
  (transient-define-prefix wal/register-dispatch ()
    ...
    [["Store to register"
     ...
     ["Load from register"
      ("l" "load with consult" consult-register-load)
  ...
  (wal/univ-consult-buffer
   wal/consult-dispatch
   wal/register-dispatch)
  :demand
  :after vertico)
#+END_SRC
    ...
    [["Capture"
     ...
     ["Visualization"
      ...
      ("u" "ui" org-roam-ui-mode
       :inapt-if-not (lambda () (require 'org-roam-ui nil t)))]])
  :custom
...
(use-package org-transclusion
  ...
  (transient-define-prefix wal/org-transclusion ()
    ...
    [["Transclusion commands"
      ...
      ("x" "remove" org-transculsion-remove)
  ...
  (transient-define-prefix wal/lisp ()
    ...
    [["Slime"
      ...
      ("r" "open REPL" slime
       :inapt-if not (lambda (featurep 'slime)))]])
  :general
  (wal/general :keymaps 'lisp-mode-map :major-modes t
    wal/general-key 'wal/lisp)
  :ensure nil)
#+END_SRC
 ...
 (transient-define-prefix wal/clojure ()
   ...
   [["Cider"
     ...
     ("n" "set namespace" cider-repl-set-ns
      :inapt-if-nil (lambda () (featurep 'cider)))]])
 :general
 (wal/general :keymaps 'clojure-mode-map :major-modes t
   wal/general-key 'wal/clojure)
 :ensure nil)
#+end_src
...
(use-package lsp-dart
  ...
  :general
  (wal/major :keymaps 'dart-mode-map :major-modes t
    wal/major-key 'wal/flutter)
  :after lsp-mode
  :ensure nil)
#+END_SRC
