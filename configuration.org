...
Register language servers. You will have to install them yourselves.

If you use Elixir, get the language server from [[https://github.com/elixir-lsp/elixir-ls][here]].

If you use Prolog, check instructions [[https://emacs-lsp.github.io/lsp-mode/page/lsp-prolog/][here]].
