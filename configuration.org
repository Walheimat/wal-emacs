...
#+OPTIONS: toc:nil
* emacs config
Check out [[https://gitlab.com/Walheimat/emacs-config/-/blob/master/.emacs.example][my init file]] for reference. To use (and assuming you're in =~/.emacs.d/emacs-config=, run =cp .emacs.example ../../.emacs=.
