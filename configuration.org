...
This project is my personal Emacs (26.3)[fn:1] config.
...
;; if you want to banish your pointer
...
(defcustom my-dark-emacs-theme 'doom-palenight
...
If you wish to know more about any of them, check out the list[fn:6] of repositories
...
You need to install the icons yourself[fn:3].
...
A possible replacement for =telephone-line=.
It looks really nice but I might consider it "too busy" eventually.
...
(use-package flycheck
  :delight " fly"
  :bind (("C-c q n" . flycheck-next-error)
         ("C-c q p" . flycheck-previous-error))
...
[fn:1] I built version =27.1= from source and tested the config a bit.
...
[fn:3] *Note* that this config uses the =all-the-icons= package
