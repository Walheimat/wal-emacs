...
+ =H-<number>= splits horizontal (=2=), vertical (=3=) or kills (=4=).
...
[fn:6] 107 code blocks, to be exact.
...
[fn:9] For Elixir, get the language server from [[https://github.com/elixir-lsp/elixir-ls][here]].

For Prolog, check instructions [[https://emacs-lsp.github.io/lsp-mode/page/lsp-prolog/][here]].
