...
Note that a lot of these are defined in the [[*packages][packages]] section.
...
#+END_SRC
**** alchemist
Elixir tooling. Make sure to read the [[https://alchemist.readthedocs.io/en/latest/basic_usage/][docs]].
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
**** origami
Bringing this back. Performance is not great though.
#+BEGIN_SRC emacs-lisp
(use-package origami
