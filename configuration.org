...
(use-package dap-mode
  ...
  (require 'dap-node)
  (require 'dap-python)
  :bind (("C-c u u" . dap-debug)
         ("C-c u t" . dap-debug-edit-template)
	 ("H-u"     . dap-debug)
         (:map dap-mode-map
               ("?" . dap-hydra)))
  :hook 
  ((js2-mode    . dap-auto-configure-mode)
   (python-mode . dap-auto-configure-mode)))
#+END_SRC

***** Debug Templates

This is just an example, ideally, you put templates
in your project root.

This one is for attaching to a containerized node app running =nodemon=.
...
(dap-register-debug-template
  ...
  (list :type "node"
  	...
  	:localRoot "/home/user/path/to/root"
	:port 9229
	:name "Nodemon::Attach"))
#+END_SRC
